...
def parse_args():
    ...
    parser.add_argument('--model_path', type=str,
                        default='/home/tyl/code/bow/vit/PyTorch-Pretrained-ViT/model_best.pth.tar')
...
def main():
    ...
    for i, case in enumerate(sorted(os.listdir(data_path))):
        ...
        for img_name in os.listdir(case_dir):
            ...
            try:
                ...
                final_pred, _, _ = model(image, weather_idx)
                ...
                print(f'案例{case}: 中出现了训练集没有的天气 {weather}')
    ...
    data.to_csv('no_weather.csv', index=False, encoding='gbk')
